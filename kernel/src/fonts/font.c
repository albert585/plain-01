...
//	(bdf2c is the conversion tool; this generated file's font DATA
//	 is licensed separately below, per X License terms.)
//
// Font data: UNI-VGA (Unicode VGA font), u_vga16.bdf
//	Copyright (c) 2001 by Dmitry Yu. Bolkhovityanov (bolkhov@inp.nsk.su)
//	http://www.inp.nsk.su/~bolkhov/files/fonts/univga/
//	License: X License (MIT-style, permissive).
//	Basic Latin block derived from DosEmu's vga.bdf.
//	The font can be distributed and modified freely, according to the X license.
